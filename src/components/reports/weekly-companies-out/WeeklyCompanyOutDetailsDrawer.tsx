...
import type { WeeklyCompanyOutItem } from "./WeeklyCompaniesOutTable";

type Props = {
  open: boolean;
  item: WeeklyCompanyOutItem | null;
  onClose: () => void;
};

const WeeklyCompanyOutDetailsDrawer: React.FC<Props> = ({
  open,
  item,
  onClose,
}) => {
  return (
    <SideDrawer open={open} onClose={onClose} title="Company OUT Details">
      {!item ? (
        ...
        <div className="space-y-5">
          <div className="rounded-2xl bg-gray-50 p-4">
            ...
            <div className="mt-1 text-xs text-gray-500">
              Operator:{" "}
              <span className="text-gray-800">{item.operatorName}</span>
            </div>
          ...
          <div className="rounded-2xl bg-white border border-gray-100 p-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-xl bg-gray-50 p-3">
                <div className="text-[10px] text-gray-500">Jobs OUT</div>
                <div className="text-lg font-semibold">{item.jobsOut}</div>
              </div>
              <div className="rounded-xl bg-gray-50 p-3">
...
export default WeeklyCompanyOutDetailsDrawer;
